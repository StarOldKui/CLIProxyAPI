...
export function MainLayout() {
  ...
  // Write the floating top control height to a CSS variable for mobile sticky offsets.
  useLayoutEffect(() => {
  ...
  // Write the main content center to a CSS variable for bottom overlay alignment.
  useLayoutEffect(() => {
  ...
  useEffect(() => {
    fetchConfig().catch(() => {
      // Ignore initial failure; the login flow will surface it.
    });
  }, [fetchConfig]);
